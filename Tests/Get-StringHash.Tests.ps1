...
Describe "Get-StringHash" {
    It "Returns correct SHA256 hash for 'hello'" {
        ...
        $expected = "2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824" # DevSkim: ignore DS173237 because it is a known hash value
        $result | Should -Be $expected
    }
    It "Returns correct SHA512 hash for 'hello'" {
        $result = Get-StringHash -String "hello" -HashName "SHA512"
        $expected = "9b71d224bd62f3785d96d46ad3ea3d73319bfbc2890caadae2dff72519673ca72323c3d99ba5c11d7c7acc6e14b8c5da0c4663475c2e5c3adef46f73bcdec043" # DevSkim: ignore DS173237 because it is a known hash value 
        $result | Should -Be $expected
    }
    It "Throws for unsupported algorithm" {
        { Get-StringHash -String "hello" -HashName "MD5" } | Should -Throw # DevSkim: ignore DS126858 because we are testing unsupported algorithm handling
    }
    ...
    It "Supports pipeline input" {
        ...
        $expected = @(
            "2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824", # DevSkim: ignore DS173237 because it is a known hash value
            "486ea46224d1bb4fb680f34f7c9ad96a8f24ec88be73ea8e5a6c65260e9cb8a7" # DevSkim: ignore DS173237 because it is a known hash value
        )
